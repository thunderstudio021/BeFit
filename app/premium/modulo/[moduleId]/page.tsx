...
// Simulando dados do módulo
const moduleData = {
  id: 0,
  title: "Clique Abaixo para fazer o Download do seu eBook",
  subtitle: "1 módulo • 5 aulas",
  progress: 0,
  currentLesson: 1,
  lessons: [
    {
      id: 1,
      title: "EMAGREÇA EM 30 DIAS - Guia Completo (baixe o ebook)",
      duration: "14s",
      attachments: 1,
      completed: false,
    ...
    {
      id: 2,
      title: "RECEITAS DETOX - Dicas e Receitas (baixe o ebook)",
      duration: "14s",
      attachments: 1,
      completed: false,
      videoUrl: "/placeholder-video.mp4",
    ...
    {
      id: 3,
      title: "EXERCÍCIOS - Para fazer em Casa ou na Academia (baixe o ebook)",
      duration: "14s",
      attachments: 1,
      completed: false,
      videoUrl: "/placeholder-video.mp4",
    ...
    {
      id: 4,
      title: "ÁUDIO DE MEDITAÇÃO GUIADA",
      duration: "17min",
      attachments: 0,
      completed: false,
      videoUrl: "/placeholder-video.mp4",
    ...
    {
      id: 5,
      title: "RECEITA BÔNUS - CHÁ PRA SECAR DA BIA",
      duration: "14s",
      attachments: 1,
      completed: false,
      videoUrl: "/placeholder-video.mp4",
  ...
  downloadMaterial: {
    title: "Emagreça em 30 Dias com um Plano 100 Prático.pdf",
    icon: "📎",
  },
}
